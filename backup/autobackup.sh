...
clear
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "               ${WB}----- [ Autobackup Data $sts ] -----${NC}              "
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "${MB}[1].${NC}  ${YB}Start Autobackup${NC}"
echo -e "${MB}[2].${NC}  ${YB}Stop Autobackup${NC}"
echo -e "${MB}[3].${NC}  ${YB}Ganti Email Penerima${NC}"
echo -e "${MB}[4].${NC}  ${YB}Ganti Email Pengirim${NC}"
echo -e "${MB}[5].${NC}  ${YB}Test kirim Email${NC}"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
