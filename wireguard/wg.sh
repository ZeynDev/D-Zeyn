...
# ==================================================
# Link Hosting Kalian
fisabiliyusri="raw.githubusercontent.com/ZeynDev/D-Zeyn/main/wireguard"
...
echo -e "${Info} Wireguard Script Mod By ZeynXD"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/ZeynDev/D-Zeyn/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/ZeynDev/D-Zeyn/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/ZeynDev/D-Zeyn/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
