...
Untuk Mengizinkan Root Dan Ubah Password Login di VPS Google Cloud Platform, Aws, Dan Lain-lain
   ```html
  wget -qO- -O vpsroot.sh https://raw.githubusercontent.com/ZeynDev/D-Zeyn/main/vpsroot.sh && bash vpsroot.sh
  ```
...
Part 3: Install Semua Layanan VPN /Install All VPN Service
  ...
  ```html
rm -f setup.sh && apt update && apt upgrade -y && update-grub && sleep 2 && apt-get update -y && apt-get upgrade && sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl unzip && wget https://raw.githubusercontent.com/ZeynDev/D-Zeyn/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh
```
...
```html
cd /usr/bin/ && rm -f sl-fix && wget -O sl-fix "https://raw.githubusercontent.com/ZeynDev/D-Zeyn/main/sslh-fix/sl-fix" && chmod +x sl-fix && cd && updatemenu && menu
 ```
### 4.1
...
```html
cd /usr/bin && wget https://raw.githubusercontent.com/ZeynDev/D-Zeyn/main/ssh/slhost.sh && bash slhost.sh
 ```
...
* lalu update cert
```html
wget https://raw.githubusercontent.com/ZeynDev/D-Zeyn/main/xray/certv2ray.sh && chmod +x certv2ray.sh && bash certv2ray.sh
 ```
* atau
```html
certv2ray
